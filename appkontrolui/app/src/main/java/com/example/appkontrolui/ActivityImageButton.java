...
public class ActivityImageButton extends Activity
{
    ...
    { super.onCreate(savedInstanceState); setContentView(R.layout.control_imagebutton);
...
// Toast tidak memerlukan aksi pengguna (akan hilang sendiri)
            Toast.makeText(getApplicationContext(),"Gambar terClick", Toast.LENGTH_LONG).show();
        }
        });
    }

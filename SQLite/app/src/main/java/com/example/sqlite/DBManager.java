...
public class DBManager {
        ...
        // Query insert data
        public void insert(String kelas, String nama) { ContentValues contentValue = new ContentValues();
        ...
        // Query update data
        public int update(long _id, String kelas, String nama) { ContentValues contentValues = new ContentValues();
